...
def roll_dice(num_rolls, dice=six_sided):
    ...
    while k<=num_rolls:
        current_dice=dice()
        total,k=current_dice+total,k+1
        if current_dice==1:
            total=1
            break
    return total
...
def is_swap(score0, score1):
    ...
    # BEGIN PROBLEM 4
    "*** YOUR CODE HERE ***"
    if (score0>1 and score1>1) and (score1%score0==0 or score0%score1==0):
        return True
    else:
        return False
    # END PROBLEM 4
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    0's score first,
    A strategy is a function that tak and Player 1's score second.
es two total scores as arguments (the
...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    def say2(score0,score1):
        ...
        minus=now_score-previous_score
        if minus>previous_high:
            if is_swap(score0,score1) and now_score>opponent_score:
                print("Due to the Swine Swap, player",who," gains the biggest point",minus,"!")
            elif minus>previous_high:
                print(minus,"! That's the biggest gain yet for player",who)
            return announce_highest(who, minus, now_score)
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    Assume that the dice always return positive outcomes.求达到平均回合的最大得分要一回合要掷几次骰子
